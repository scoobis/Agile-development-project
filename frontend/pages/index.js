...
const heroContent = {
  ...
  description: 'Minska matsvinnet – En krokig morot är lika bra mat som en rak!',
  ...
  return (
    <Layout pt='0'>
      ...
      <Container maxWidth={false} disableGutters style={{ backgroundColor: '#f9f9f9' }}>
        <Grid container>
          <Grid item md={6}>
            <Box display='flex' flexDirection='column' justifyContent='center' height='100%' padding='60px'>
              <Box mb={3}>
                <Typography variant='h3'>Handla ekologiskt från producenter nära dig</Typography>
              </Box>
              <Box mb={2}>
      ...
      <Container style={{ paddingTop: '60px', paddingBottom: '60px' }}>
        <Grid container spacing={3}>
          ...
          <Grid item md={6}>
            ...
            <Typography>
              <Link href={LOGIN_PATH}>Logga in</Link>
            </Typography>
            <Typography>
              <Link href={PRODUCER_DASHBOARD_PATH}>Producenter</Link>
            </Typography>
          </Grid>
        </Grid>
      </Container>
